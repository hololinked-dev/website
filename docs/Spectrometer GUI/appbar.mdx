...
import SpectrometerApp from '../../src/components/examples/spectrometer/App' 
...
```tsx {9,44-46,48} showLineNumbers title='/src/App.tsx'
...
RemoteObject accessible, you could already try the app bar functionality from the example output at the top of the page. 